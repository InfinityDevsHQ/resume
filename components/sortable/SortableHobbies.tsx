...
interface SortableHobbiesProps {
  sortableHobbiesList: any;
  setSortableHobbiesList: any;
  setToggledHobbies: any;
  toggledHobbies: any;
}

const SortableHobbies: React.FC<SortableHobbiesProps> = ({
  sortableHobbiesList,
  setSortableHobbiesList,
  setToggledHobbies,
  toggledHobbies,
}) => {
  ...
  const handleDeleteDiv = (index: any) => {
    setSortableHobbiesList((sortableHobbiesList: any[]) =>
      sortableHobbiesList.filter((_: any, i: any) => i !== index)
    );
    if (sortableHobbiesList.length <= 1) {
  ...
  return (
    <>
      {sortableHobbiesList.map((item: any, index: any) => (
        <div
          key={index}
